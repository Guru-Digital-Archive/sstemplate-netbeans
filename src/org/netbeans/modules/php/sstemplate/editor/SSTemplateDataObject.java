...
public class SSTemplateDataObject extends MultiDataObject {

    public SSTemplateDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
